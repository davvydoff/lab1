...
#   5) Показать готовый Xray outbound для WARP
#   0) Выход
# ============================================================
...
setup_warp_wgquick() {
    ...
    echo
    echo -e "${YELLOW}В RemnaWave/Xray используй outbound из пункта меню 5.${NC}"
}
...
main_menu() {
    ...
    while true; do
        ...
        echo "5) Показать Xray outbound/routing для WARP"
        echo "0) Выход"
        echo
